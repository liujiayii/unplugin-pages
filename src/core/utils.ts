...
export const debug = {
  // hmr: Debug('unplugin-pages:hmr'),
  routeBlock: Debug('unplugin-pages:routeBlock'),
  options: Debug('unplugin-pages:options'),
  pages: Debug('unplugin-pages:pages'),
  search: Debug('unplugin-pages:search'),
  env: Debug('unplugin-pages:env'),
  cache: Debug('unplugin-pages:cache'),
  resolver: Debug('unplugin-pages:resolver'),
}
